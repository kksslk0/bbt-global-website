...
export const products: ProductDownload[] = [
  {
    ...
    description: {
      ...
      'zh-cn': 'AI 驱动的多语言实时翻译工具，支持文字、语音和文件翻译。',
    ...
    actionHint: {
      ...
      'zh-cn': '点击下方按钮前往 App Store 下载 BBT 翻译器。',
  ...
  },
  {
    ...
    description: {
      ...
      'zh-cn': 'Web3 钱包原生实时通讯平台，万人社区、代币门控、链上身份。',
    ...
    actionHint: {
      ...
      'zh-cn': '跨语言社交网络正在内测打磨中，开放后会第一时间提供下载入口。',
  ...
  },
  {
    ...
    description: {
      ...
      'zh-cn': 'WebRTC 实时语言课堂、积分激励体系、NFT 学习证书。',
